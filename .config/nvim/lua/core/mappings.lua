...
M.telescope = {
  ...
  n = {
    -- find
    ["<leader>ff"] = { "<cmd> Telescope find_files <CR>", "Find files from ./" },
    ...
    -- open telescope and search only in current directory
    ["<leader>fF"] = { "<cmd> Telescope find_files cwd=~ <CR>", "Find files in any directory from ~" },
